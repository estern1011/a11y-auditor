/**
 * Pure types, constants, and parsing for VoiceOver output.
 *
...
// ---------------------------------------------------------------------------
// Key codes and modifiers for raw keystrokes
// ---------------------------------------------------------------------------
...
export function parseVoResponse(spoken: string, itemText: string): VoResponse {
  ...
  // Fresh regex per call — avoids shared lastIndex state from the `g` flag
